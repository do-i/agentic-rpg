...
- prevent pass-thru NPC
- for debug purpose, add all members at the begining, boolean flag (config yaml) to toggle debug mode
- smooth movement: currently sprite moves into collision object - e.g., wall or tree. When such collision occurs, sprite should move left or right. make this configurable in yaml
-
